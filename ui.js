  ...
  function init()
  {
    ...
    if (rcmail.env.task == 'mail') {
      ...
      if (rcmail.env.action == 'show' || rcmail.env.action == 'preview') {
        ...
        new rcube_splitter({ id:'composesplitterv', p1:'#composeview-right',
      ...
      if ($('#mailview-left').length) {
        new rcube_splitter({ id:'mailviewsplitterv', p1:'#mailview-right',
    ...
    /***  addressbook task  ***/
      ...
      if (rcmail.env.action == '') {
        new rcube_splitter({ id:'addressviewsplitterd', p1:'#addressview-right',
